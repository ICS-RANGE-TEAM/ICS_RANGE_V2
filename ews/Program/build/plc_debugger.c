 ...
 * Declare programs 
 **/
extern DISPATCH RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.INT_PYLONE), BOOL_ENUM},
{&(RES0__INSTANCE0.INT_PYLONE_STATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.INT_TRANSFORM_A), BOOL_ENUM},
{&(RES0__INSTANCE0.INT_TRANSFORM_A_STATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.INT_TRANSFORM_B_STATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.INT_TRANSFORM_AETB_STATUS), BOOL_ENUM}
};
